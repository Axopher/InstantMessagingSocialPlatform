...
SECRET_KEY = 'django-insecure-19y2y4d@jwy@y8*d72x%^6o_w7m=%j%da7i8(h5)@k)zbf6#zp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


# allowed_hosts = all the urls that are allowed to go this website or point to it
ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    ...
    # to tell studybud that base app exists we do the below process 
